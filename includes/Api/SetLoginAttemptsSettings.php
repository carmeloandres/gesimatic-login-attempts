...
/**
 * Class SetLoginAttemptsSettings
 *
 * This class contains the code necessary to manage the data from set_login_attempts_settings api request.
 *
 * @package gesimatic-login-attempts
 */
class SetLoginAttemptsSettings implements ActionInterface{
...
//                    error_log ('SetLoginAttemptsSettings validate, $sanitized_params: '.var_export($sanitized_params,true));
    ...
    public static function handle($settings){
        ...
        if (is_array($settings)){
            ...
            $data['success'] = false;
            $data['message'] = __('Failed to update settings', 'gesimatic-login-attempts');
