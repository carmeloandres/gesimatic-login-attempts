...
class Setup {
     ...
     * @since 1
     */
    protected const OPTION_BLOCKED_IPS = 'gesimatic_login_attempts_blocked_ips';
     ...
     * @since 1
     */
    protected const SPOTLIGHT_QUERING_BLOCKED_IPS = 'gesimatic_login_attempts_quering_blocked_ips_spotlight';
