...
$text_domain = 'gesimatic-login-attempts';
$javascript_file_name = 'gesimatic-login-attempts-admin.js';
$css_file_name ='gesimatic-login-attempts-admin.min.css';
...
$list_of_plugin_files = scandir($dir_plugin.'/includes');
